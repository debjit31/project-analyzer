...
import { Zap, Mail, Lock, Globe, GitBranch, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          <h1 className="text-2xl font-bold text-neutral-100 mb-1">Welcome back</h1>
          <p className="text-sm text-neutral-400 mb-6">Sign in to your account to continue</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-neutral-500">
              <span className="bg-neutral-900 px-3">or continue with email</span>
            </div>
          </div>
